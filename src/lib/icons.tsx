...
export const choreIconImages = {
  ...
  pareti: "/chore-icons/pareti.jpg",
  battiscopa: "/chore-icons/battiscopa.jpg",
  ...
  infissi: "/chore-icons/infissi.jpg",
  "mobiletti-esterni": "/chore-icons/mobiletti-esterni.jpg",
  lampadario: "/chore-icons/lampadario.jpg",
  "addolcitore-manutenzione": "/chore-icons/addolcitore-manutenzione.jpg",
  "addolcitore-sale": "/chore-icons/addolcitore-sale.jpg",
  mattonelle: "/chore-icons/mattonelle.jpg",
  "tubi-esterni": "/chore-icons/tubi-esterni.jpg",
...
export const choreIconOptions: Array<{ value: ChoreIconName; label: string }> = [
  ...
  { value: "mobiletti-esterni", label: "Mobiletti esterni" },
  { value: "lampadario", label: "Lampadario" },
  { value: "addolcitore-manutenzione", label: "Addolcitore manutenzione" },
  { value: "addolcitore-sale", label: "Sale addolcitore" },
  { value: "mattonelle", label: "Mattonelle" },
  { value: "tubi-esterni", label: "Tubi esterni" },
